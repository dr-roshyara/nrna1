...
use App\Models\Candidacy;
$candi = new Candidacy;
$candi->user_id = "nrna_13";
$candi->candidacy_id = "TEST_2025_13";
$candi->post_id = "2025_03";
$candi->proposer_id = "DE10219"; // Link to the proposer's nrna_id
$candi->supporter_id = "DE1000019"; // Link to the supporter's nrna_id
...
use App\Models\Candidacy;
$candi = new Candidacy;
$candi->user_id = "nrna_14";
$candi->candidacy_id = "DE25_205";
$candi->post_id = "2025_03";
$candi->proposer_id = "DE10020"; // Link to the proposer's nrna_id
$candi->supporter_id = "DE10020"; // Link to the supporter's nrna_id
