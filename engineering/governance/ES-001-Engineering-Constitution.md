...
|---|---|---|
| **RECORD: …** | *"Put my business decision, fact, instruction, or event into the official record."* | whatever internal transitions the act requires (`REGISTER` · `HANDOFF` · grants · registrations) |
