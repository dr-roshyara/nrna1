...
**Material context (ARB-refined wording, 2026-07-11):** the commission requested a governance recommendation (*"End with exactly one recommendation: Authorize C3 or Do not authorize C3"*). **The instrument complied — and that compliance was itself the failure:** a verification instrument always has the responsibility to protect its constitutional boundary, even when asked to cross it. **Future verification instruments should instead record: "Decision requested by the commission. Outside verification authority — referred to the Decision Authority."** The same commission-induced pattern exists in the baseline readiness report; the principle protects the constitution rather than explaining the exception.
