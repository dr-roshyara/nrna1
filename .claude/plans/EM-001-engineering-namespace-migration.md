...
**Created:** 2026-07-10 · **Status:** ✅ EXECUTED 2026-07-10 — authoritative record: `engineering/MIGRATION_REPORT.md` (the matrix below is the original proposal, kept as history; ARB amendments during execution: D1 overturned — ADR-AIP moved; `knowledge/harvests/` not `research/`; no empty namespace folders — create a folder only when its first artifact arrives; incremental move→verify→commit loop). Entry point: `engineering/README.md`.
