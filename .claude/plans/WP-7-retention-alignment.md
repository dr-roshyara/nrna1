...
**Decision pack for a single ARB session (four items, four votes, no outcomes pre-filled):** `engineering/verification/reports/2026-08-01-arb-session-decision-pack.md`.
