...
- **Detail:** PB-003 Inbox / Deduplication · Lifecycle: **In Development** · Progress: 10/18 WBS (C3 ✔ 8930f47fd) · IDD: `docs/implementation/backlog/PB-003_Inbox_Implementation_Design.md`
...
PB-003-C4 · Process v1.0 step 4 (RED): failing tests for **InboxHandlerRegistry** ((consumer_context, event_type)→handler; duplicate registration rejected) + container wiring. C1 port ✔ · C2 persistence ✔ · C3 wrapper ✔ 8930f47fd.
