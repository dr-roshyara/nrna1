...
- **→ Next: STOP for ARB review of step 2** (one-step discipline). Then Step 3 = **PB-004 RED (C1 Domain)** — Election consumes `DeterminationIssued` schema v2.
Messaging unaffected (consume-only); anonymity preserved. Traceable to ADR-UL-01/ADR-PL-01.
