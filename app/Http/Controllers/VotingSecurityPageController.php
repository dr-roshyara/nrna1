...
class VotingSecurityPageController extends Controller
{
    /**
     * Display the voting security page.
     */
    public function show(): Response
    {
        return Inertia::render('Public/VotingSecurity', [
    ...
    private function getCtaButtons(): array
    {
        return [
            [
                'id' => 'cta-demo',
                'labelKey' => 'pages.votingSecurity.cta.demo',
                'href' => '/election/demo/start',
                'variant' => 'primary',
            ],
            [
                'id' => 'cta-whitepaper',
                'labelKey' => 'pages.votingSecurity.cta.whitepaper',
                'href' => '#whitepaper',
                'variant' => 'secondary',
            ],
        ];
