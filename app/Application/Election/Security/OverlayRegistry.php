...
final class OverlayRegistry
{
    private static array $definitions = [
        [
            ...
            'influences'         => [OverlaySignalCategory::REQUIRE_CONSTITUTIONAL_REVIEW],
        ...
        [
            ...
            'influences'         => [OverlaySignalCategory::TRUST_ELEVATION_REQUEST],
        ...
        [
            ...
            'stratification'     => OverlayStratification::OPERATIONAL_LAYER,
            'influences'         => [OverlaySignalCategory::TRUST_EVALUATION_INCONCLUSIVE],
            'registrar_required' => false,
            'federation_aware'   => false,
            'order'              => 4,
        ],
        [
            ...
            'influences'         => [OverlaySignalCategory::REQUIRE_RE_VERIFICATION],
            'registrar_required' => false,
            'federation_aware'   => false,
            'order'              => 5,
        ],
