# Translation Keys: Organisation Landing Page Demo Results Section
...
### Step 2: Add Keys to Existing File

**For each file (en.json, de.json, np.json):**

1. Open the file
2. Find the closing brace `}`
3. Add a comma before it
4. Add the keys from above (without the outer `{}`)
5. Keep same indentation as existing keys
...
### Step 3: Verify Keys in Component
...
All keys must match exactly (case-sensitive).
...
**German:**
- "Organisations-Demo-Ergebnisse" (feminine plural)
- Proper noun capitalization maintained

**Nepali:**
- "डेमो चुनाव परिणाम" (standard form)
- Readable in both Devanagari script

### Length Considerations

| Language | Avg Length | Max Length |
|----------|-----------|-----------|
| English | Short | ~100 chars |
| German | +20% longer | ~120 chars |
| Nepali | Variable | ~100 chars |

**Tested with Tailwind classes:**
- All text fits in card layouts
- No overflow issues
...
**Maintained:**
- "Public Digit" (English, all languages)
- "MODE 1" / "MODE 2" (technical terms, universal)
- "Demo" (clear meaning, not translated)
...
- [ ] All keys added to de.json
- [ ] All keys added to np.json
- [ ] No syntax errors in JSON
- [ ] Keys match component usage
- [ ] Tested in browser (all 3 languages)
- [ ] Component renders without errors
- [ ] Text displays correctly on all breakpoints
- [ ] No special characters broken
- [ ] Links work (MODE 1 & MODE 2)
...
Demo Cards:
  .org-demo-title, .org-demo-desc, .org-demo-aria
  .global-demo-title, .global-demo-desc, .global-demo-aria
...
- **Component:** `resources/js/Pages/Organizations/Partials/DemoResultsSection.vue`
- **Page:** `resources/js/Pages/Organizations/Show.vue`
- **Other Translation Keys:** `TRANSLATION_KEYS_DEMO_RESULTS.md`
