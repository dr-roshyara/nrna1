...
$candi = new Candidacy;
$candi->user_id = "nrna_01";
$candi->candidacy_id = "DE_TEST_2025_123";
$candi->post_id = "2025_02";
$candi->proposer_id = "DE1023216"; // Link to the proposer's nrna_id
$candi->image_path_1 = "-";
$candi->image_path_2 = "-";
$candi->image_path_3 = "-";
$candi->save();
...
$candidateUser->user_id =301
$candidateUser->first_name = "Pokhara";
$candidateUser->last_name = "City";
$candidateUser->email = "pokhara1@example.com";
$candidateUser->password = Hash::make('password');
// Add other required fields...
$candidateUser->save();
...
use App\Models\Candidacy;
$candi = new Candidacy;
$candi->user_id = 301; // Link to the candidate's user ID
$candi->candidacy_id = "TEST_2025_03";
$candi->post_id = "2025_02";
$candi->proposer_id = "DE10010218"; // Link to the proposer's nrna_id
$candi->supporter_id = "DE10100219"; // Link to the supporter's nrna_id
...
$candi->candidacy_id = "TEST_12021_04";
$candi->post_id = "2021_04";
...
// Create the user who is the candidate
$candidateUser = new User;
$candidateUser->name = "Anuradha Koirala ";
$candidateUser->user_id ="nrna_20"
$candidateUser->first_name = "Anuradha Koirala";
$candidateUser->last_name = "Koirala";
$candidateUser->email = "anuradha@example.com";
$candidateUser->password = Hash::make('password');
$candidateUser->save();
...
use App\Models\Candidacy;
$candi = new Candidacy;
$candi->user_id = "nrna_20";
$candi->candidacy_id = "TEST_2025_121";
$candi->post_id = "2025_04";
$candi->image_path_1 = "anuradha.jpg";
$candi->image_path_2 = "-";
$candi->image_path_3 = "-";
$candi->save();
#
...
$candi->candidacy_id = "DE_TEST_2021_25";
$candi->post_id = "2025_03";
$candi->proposer_id = "DE10ss0121"; // Link to the proposer's nrna_id
$candi->supporter_id = "DE100ss122"; // Link to the supporter's nrna_id
...
#************************************************
$candidateUser = new User;
$candidateUser->name = "Citwan National Park";
$candidateUser->user_id =8
$candidateUser->first_name = "Chitwan";
$candidateUser->last_name = "National Park";
$candidateUser->email = "chitwan@example.com";
$candidateUser->password = Hash::make('password');
$candidateUser->save();
...
use App\Models\Candidacy;
$candi = new Candidacy;
$candi->user_id = 8; // Link to the candidate's user ID
$candi->candidacy_id = "2025_08";
$candi->post_id = "2025_06";
$candi->proposer_id = "DE121230"; // Link to the proposer's nrna_id
$candi->supporter_id = "DE1233230"; // Link to the supporter's nrna_id
$candi->image_path_1 = "chitwan.jpg";
$candi->image_path_2 = "-";
$candi->image_path_3 = "-";
$candi->save();
#
