...
| [`PBDIGIT-44`](PBDIGIT-44-locale-messages-break-pages-with-no-gate.md) | 🔴 **A locale string broke a public page** (`@` is vue-i18n syntax) — **fixed**; the missing i18n gate is open | cross-cutting | `@` class **FIXED** · `{{ }}` class + gate `OPEN` |
