...
| [`PBDIGIT-48`](PBDIGIT-48-election-state-has-four-representations.md) | **Login routing reads a deprecated field instead of the constitutional lifecycle** — an unfinished migration, not competing authorities | `EPIC-03` | 🟡 **DISCOVERY** — the cause behind `PBDIGIT-47` |
