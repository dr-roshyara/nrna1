...
| [`PBDIGIT-58`](PBDIGIT-58-complete-legacy-election-state-migration.md) | **Complete the legacy election-state migration** — Option B approved; 6 slices, `58A` observes before anything is migrated | `EPIC-03` | ⬜ **AWAITING AUTHORISATION** |
