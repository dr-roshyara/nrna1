...
| **Discovery** | [`2026-08-06-who-owns-the-votes-per-ip-rule.md`](../reviews/2026-08-06-who-owns-the-votes-per-ip-rule.md) **rev 3** (four questions answered · ownership traceability) |
| **ADR** | 🟡 [`ADR_20260806_1620_Constitutional_Rule_Ownership_Migration`](../adr/ADR_20260806_1620_Constitutional_Rule_Ownership_Migration.md) — **PROPOSED. Nothing may be removed until it is accepted** |
| **First action** | **Read the divergence evidence.** `SovereigntyDivergenceSummary` + `D02AggregateConstitutionalDivergence` have never been run, and they answer whether the two authorities actually disagree |
