...
| **Status** | 🟡 **PROPOSED — ⛔ UNAUTHORIZED. No code written.** ⭐ **Authority sought: EP-01 PLAN APPROVAL from the Decision Authority** *(`R-46` precedent: EP-01 plan approval is the DA's act, not the ARB's — the `CAP-001` plan `20260802-0015` states it)* |
