...
**ER-09 — Project Knowledge Management (Documentation Architecture). STATUS: PROPOSED — PAUSED pending RQ-002 research (ARB elevation, 2026-07-11: the durable question is "what is project knowledge?", not "how are documents stored"; rename to "Project Knowledge Architecture" is a candidate outcome). Ratification earliest at v1.1 after RQ-002; execution vehicle: EPIC-000 Stream B.**
