...
---
*Frozen inputs: `EPIC-004I` (repositories; RMSP adopted at its freeze) · the full frozen chain №2–№8 · `EPIC-004_Q1_Authority_Resolution.md` (binding constraint) · ADR-T17 (the placement now flagged) · Implementation evidence: EPIC-003 inventory (empty `Domain/Policies/`; the Application-layer service trio).*
