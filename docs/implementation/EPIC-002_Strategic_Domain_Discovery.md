...
| **Adjudication / Correction** | Resolving contradictory, incomplete, or contested evidence into a determination; consistently non-automatic wherever examined | "knowledge crunching" (Evans), "reconciliation," "curing/Heilung" (AL Germany), "declare-failure" (ES), "remediation" (audit governance) | ES, AL, PR, E2E-VV, GT, DDD (11 families) | HIGH |
...
- **Cluster B — Adjudication & Correction:** R2/C2/D1/K1 — the most robustly and tightly co-occurring cluster in the entire evidence base (11 independent families); every discipline naming an adjudication responsibility also discusses its non-automatic nature and what, if anything, could ever automate it.
