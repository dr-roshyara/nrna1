...
| PB-003 | Inbox / Deduplication | **In Development** (C6A ✔ 305cfb9ff) | `█████████░` 89% (Port✔ Infra✔ Registry✔ Commands✔ Testing✔ Arch-Verify✔ · C6B cert pending) | 16/18 | L | Medium (no arch uncertainty) | PB-001 ✔ PB-002 ✔ | feature/pb003 | 2026-07-07 |
...
**Derived epic progress: 33 / 103 WBS items = 32%** *(estimated counts marked; recomputed as each IDD replaces its estimate)*
