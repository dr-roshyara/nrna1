...
**Baseline metrics (ARB-required set — MSI alone is insufficient) — MEASURED 2026-07-10 (Infection 0.29.10, greenfield-core scope, GreenfieldCore suite, 7m16s, 8 threads). STATUS: TENTATIVE (ARB @ 7D acceptance) — pending the F-7D-2 evidence-integrity validation (§2e); not verified evidence, must not drive ratchets until validated:**
| Metric | Value |
|---|---|
| **MSI** | **75%** |
