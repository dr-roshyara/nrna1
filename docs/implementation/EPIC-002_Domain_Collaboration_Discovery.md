...
**Kind:** discovery artifact — a **preparation activity inside Context Mapping** *(reclassified per ARB methodology refinement, 2026-07-25: originally produced as "Strategic DDD Phase 3"; the ARB subsequently ruled this kind of work is Context Mapping Preparation, not a permanent named lifecycle phase — the content stands unchanged as input to `EPIC-002_Context_Mapping_Readiness_Assessment.md`)*. **Authority:** generated; never authoritative without ARB review.
