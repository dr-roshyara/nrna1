...
**Kind:** the single authoritative Context Map of the ruled decomposition — authorized by the ARB's Decision Gate ruling (2026-07-25, recorded in `EPIC-002_ARB_Context_Mapping_Strategy_Decision_Request.md` §5). **Authority:** generated; becomes the canonical strategic representation **upon ARB acceptance** — and it is that acceptance, not this document's existence, that ratifies the Candidate Domain Boundaries below as **Bounded Contexts**.
