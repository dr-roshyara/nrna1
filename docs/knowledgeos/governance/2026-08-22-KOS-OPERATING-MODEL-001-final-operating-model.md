...
**Status:** **IMPLEMENTED** (this document + minimal capability + contract test). **NOT VERIFIED** (independent verification pending) · **NOT ADOPTED** · **NOT AUTHORIZED for future use.** §38 — the four states are never collapsed.
