...
- **Status:** **PROPOSED · EVIDENCE-BASED · NON-AUTHORITATIVE · NOT ADOPTED.** Corrected by erratum **P3-F1** (bounded evidence completion). ✅ **Corrected baseline APPROVED by the Human Principal Architect re-review (2026-08-22)** — `docs/knowledgeos/reviews/2026-08-22-KOS-EP01-P3-corrected-baseline-rereview-ruling.md`. **P4 gate OPEN** — Stage 4 (EKS + PKS + AIP Current Architecture Landscape) may proceed, producing the **"KnowledgeOS Constitutional Invariant Map v1.0"** per the P4 launch prompt (`2026-08-22-KOS-EP01-P4-landscape-launch-prompt.md`). This baseline remains approved for P4 consumption; it is NOT adopted as architecture.
