...
$$
\boxed{
Knowledge = resulting\ epistemic\ state
}
$$
...
$$
\boxed{
Zero \rightarrow Tension \rightarrow Orgasm \rightarrow New\ Knowledge
}
$$
...
$$
E_1:
\text{direct server inspection at }t_1
$$
...
$$
E_2:
\text{old documentation from }t_0.
$$
...
$$
\boxed{
K_{t+1}=\Gamma(E_{t+1},Q_{t+1},C_{t+1},EC_{t+1}).
}
$$
...
$$
\boxed{
Complementary\ Epistemic\ Agents
}
$$
...
\boxed{
K_{t+1}
\text{ is generated by epistemic interaction.}
}
$$
...
$$
\boxed{
Zero = awareness\ of\ epistemic\ tension/boundary
}
$$

$$
\boxed{
Inquiry = intercourse\ of\ competing\ epistemic\ positions
}
$$

$$
\boxed{
Reconciliation = processing\ the\ tension
}
$$
...
$$
\boxed{
Knowledge = offspring/new\ epistemic\ state
}
$$
...
$$
\boxed{
New\ Knowledge\rightarrow New\ Zero\ Boundary
}
$$
