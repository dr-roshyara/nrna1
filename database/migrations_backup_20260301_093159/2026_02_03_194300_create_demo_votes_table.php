...
class CreateDemoVotesTable extends Migration
{
    /**
     * Run the migrations.
     *
     * Creates demo_votes table as an exact mirror of votes table.
     * This table stores DEMO election votes only.
     * Physical separation ensures demo votes never mix with real votes.
     *
     * No unique constraint on user_id - allows same user to vote in demo and real elections.
     *
     * @return void
     */
    public function up()
    {
        Schema::create('demo_votes', function (Blueprint $table) {
            ...
            // 60 candidate columns (JSON format)
