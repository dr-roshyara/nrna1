...
$_SERVER['DB_USERNAME'] = 'publicdigit_user';
$_SERVER['DB_PASSWORD'] = 'Rudolfvogt%27%';
...
$_ENV['DB_USERNAME'] = 'publicdigit_user';
$_ENV['DB_PASSWORD'] = 'Rudolfvogt%27%';
...
putenv('DB_USERNAME=publicdigit_user');
putenv('DB_PASSWORD=Rudolfvogt%27%');
