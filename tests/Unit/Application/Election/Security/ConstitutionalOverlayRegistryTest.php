...
use App\Application\Election\Security\ConstitutionalOverlayRegistry;
use PHPUnit\Framework\TestCase;

class ConstitutionalOverlayRegistryTest extends TestCase
{
    public function test_registry_holds_definitions_not_instances(): void
    {
        $definitions = ConstitutionalOverlayRegistry::getOrderedDefinitions();
    ...
    {
        $def = ConstitutionalOverlayRegistry::findByIdentifier('emergency_condition');
    ...
    {
        $def = ConstitutionalOverlayRegistry::findByIdentifier('nonexistent_overlay');
