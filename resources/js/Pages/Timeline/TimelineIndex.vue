...
<script>
// import TimelineHeader from '@/Pages/Timeline/TimelineHeader.vue'
export default {
     component: {
        //  TimelineHeader
    }
...
<style scoped>/*! modern-normalize v1.0.0 | MIT License | https://github.com/sindresorhus/modern-normalize */
...
.dark .dark\:border-dim-200 {
  --tw-border-opacity: 1;
  border-color: rgba(56, 68, 77, var(--tw-border-opacity));
}

.dark .dark\:border-dim-400 {
  --tw-border-opacity: 1;
