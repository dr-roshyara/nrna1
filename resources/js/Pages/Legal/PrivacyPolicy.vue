            ...
            <div class="max-w-3xl mx-auto bg-white rounded-lg shadow p-8">
                ...
                <div class="prose prose-lg max-w-none text-neutral-700">
                    ...
                    <ul class="list-disc list-inside mb-6 space-y-2">
                        ...
                        <li>Process your voting or election participation</li>
                        <li>Send you promotional and marketing emails</li>
                        <li>Fulfill and send out orders, and send you related information</li>
                        <li>Generate a personal profile about you so that future visits to the platform will be personalized</li>
