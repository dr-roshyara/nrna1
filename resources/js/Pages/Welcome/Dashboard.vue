  ...
  <div class="welcome-dashboard min-h-screen bg-neutral-50 flex flex-col">
    ...
    <main class="grow max-w-4xl mx-auto w-full px-3 sm:px-4 lg:px-8 py-8 sm:py-12 lg:py-16">
      ...
      <div class="mb-8 sm:mb-12">
        <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-neutral-900 mb-2 sm:mb-3 leading-tight">
          {{ $t('pages.welcome-dashboard.header.title', { name: userName || 'User' }) }}
        </h1>
        <p class="text-base sm:text-lg lg:text-xl text-neutral-700">
          {{ $t('pages.welcome-dashboard.header.subtitle') }}
        </p>
      </div>

      <!-- German Compliance Notice -->
      <div class="mb-8 sm:mb-12 p-4 sm:p-6 lg:p-8 border border-primary-200 bg-primary-50 rounded-lg focus-within:ring-2 focus-within:ring-blue-500" role="region" aria-label="Compliance Information">
        <div class="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
          <span class="text-2xl sm:text-3xl shrink-0" aria-hidden="true">🇩🇪</span>
          <div class="w-full">
            <h3 class="text-base sm:text-lg font-bold text-neutral-900 mb-2">
              {{ $t('pages.welcome-dashboard.compliance.title') }}
            </h3>
            <p class="text-sm sm:text-base text-neutral-700 mb-3">
              {{ $t('pages.welcome-dashboard.compliance.description') }}
            </p>
            <ul class="text-xs sm:text-sm text-neutral-700 space-y-1 sm:space-y-2">
      ...
      <div class="mb-8 sm:mb-12">
        <h2 class="text-xl sm:text-2xl font-bold text-neutral-900 mb-4 sm:mb-6">
        ...
        <div class="space-y-3 sm:space-y-4">
          ...
          <div class="relative group">
            ...
            <button
              ...
              class="relative w-full p-4 sm:p-6 lg:p-8 bg-white border-2 border-primary-500 rounded-lg hover:shadow-xl focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-left group-hover:border-primary-600 disabled:opacity-50 disabled:cursor-wait"
            >
              <div class="flex items-start justify-between gap-3 sm:gap-4">
                <div class="flex items-start gap-3 sm:gap-4 min-w-0">
                  <span class="text-2xl sm:text-3xl shrink-0" aria-hidden="true">🏢</span>
                  <div class="min-w-0">
                    <div class="font-bold text-neutral-900 text-base sm:text-lg">
                ...
                <span class="text-xl sm:text-2xl text-primary-600 font-bold shrink-0" v-if="!isLoading">→</span>
                <span class="text-xl sm:text-2xl text-primary-600 animate-spin shrink-0" v-else>⌛</span>
              </div>
            </button>
          </div>
          ...
          // Join organisation
            <button
              ...
              class="p-4 sm:p-6 lg:p-8 bg-white border-2 border-neutral-200 rounded-lg hover:border-green-500 hover:shadow-lg focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all text-left disabled:opacity-50 disabled:cursor-wait"
            >
            ...
            <button
              ...
              class="p-4 sm:p-6 lg:p-8 bg-white border-2 border-neutral-200 rounded-lg hover:border-purple-500 hover:shadow-lg focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-all text-left disabled:opacity-50 disabled:cursor-wait"
            >
              <div class="flex items-start gap-3 sm:gap-4">
                <span class="text-2xl sm:text-3xl shrink-0" aria-hidden="true">📊</span>
                <div class="min-w-0">
      ...
      <div class="mb-8 sm:mb-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div class="p-4 sm:p-6 border border-neutral-200 rounded-lg bg-white hover:shadow-md focus-within:ring-2 focus-within:ring-blue-500 transition-shadow">
            <h3 class="text-base sm:text-lg font-bold text-neutral-900 mb-2">
              {{ $t('pages.welcome-dashboard.usecases.german.title') }}
            </h3>
            <p class="text-sm sm:text-base text-neutral-700 mb-4">
      ...
      <div class="mb-8 sm:mb-12 pt-6 sm:pt-8 border-t border-neutral-200">
        <h2 class="text-lg sm:text-xl font-bold text-neutral-900 mb-6 sm:mb-8 text-center">
          {{ $t('pages.welcome-dashboard.socialProof.title') }}
        </h2>
        <div class="grid grid-cols-3 gap-3 sm:gap-6 text-center">
          <div class="p-3 sm:p-6 bg-white rounded-lg border border-neutral-100">
            <div class="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary-600">50+</div>
            <div class="text-xs sm:text-sm text-neutral-700 mt-2">
              {{ $t('pages.welcome-dashboard.socialProof.orgs') }}
            </div>
          </div>
          <div class="p-3 sm:p-6 bg-white rounded-lg border border-neutral-100">
            <div class="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary-600">3</div>
            <div class="text-xs sm:text-sm text-neutral-700 mt-2">
              {{ $t('pages.welcome-dashboard.socialProof.languages') }}
            </div>
          </div>
          <div class="p-3 sm:p-6 bg-white rounded-lg border border-neutral-100">
            <div class="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary-600">100%</div>
            <div class="text-xs sm:text-sm text-neutral-700 mt-2">
      ...
      <div class="mb-8 sm:mb-12 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg sm:rounded-xl p-4 sm:p-6 lg:p-8">
        <h2 class="text-xl sm:text-2xl font-bold text-neutral-900 mb-1 sm:mb-2">
          {{ $t('pages.welcome-dashboard.keyFeatures.title') }}
        </h2>
        <p class="text-sm sm:text-base text-neutral-700 mb-4 sm:mb-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
          ...
          <div class="p-3 sm:p-4 lg:p-6 bg-white rounded-lg border border-primary-100 focus-within:ring-2 focus-within:ring-blue-500">
            <div class="text-2xl sm:text-3xl mb-2 sm:mb-3" aria-hidden="true">🔍</div>
            <h4 class="font-semibold text-neutral-900 mb-1 sm:mb-2 text-sm sm:text-base">
      ...
      <div class="mb-8 sm:mb-12 bg-yellow-50 border-l-4 border-yellow-400 p-4 sm:p-6 rounded-sm">
        <h3 class="text-base sm:text-lg font-bold text-neutral-900 mb-2 sm:mb-3">
          💡 {{ $t('pages.welcome-dashboard.tips.title') }}
        </h3>
        <ul class="space-y-1 sm:space-y-2">
          <li class="text-xs sm:text-sm text-neutral-800">
