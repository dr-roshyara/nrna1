        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div class="lg:col-span-3">
            ...
            <div v-if="$page.props.flash?.success && currentStep === 'done'"
              ...
              <p class="text-gray-600 mb-6">{{ $page.props.flash.success }}</p>
              <Link :href="route('organisations.membership.participants.index', organisation.slug)"
                  ...
                  <table class="w-full text-sm">
                    <thead class="sticky top-0 bg-gray-100 border-b border-gray-200">
                      <tr>
                        ...
                        <th class="px-3 py-2 text-left font-medium text-gray-700">{{ t.preview.table.type }}</th>
                    ...
                    <tbody>
                      <tr v-for="row in previewData.preview" :key="row.row"
                        ...
                        <td class="px-3 py-2 text-gray-700">{{ row.participant_type }}</td>
                        <td class="px-3 py-2">
