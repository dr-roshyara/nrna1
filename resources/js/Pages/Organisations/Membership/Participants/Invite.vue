    ...
    <main role="main" class="py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
          ...
          <p class="text-gray-600">{{ t.description.replace('{organisation}', organisation.name) }}</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div class="lg:col-span-3">
            ...
            <section class="bg-white rounded-lg shadow-xs p-6 mb-8">
              <h2 class="text-xl font-semibold text-gray-900 mb-6">{{ t.form.title }}</h2>
              ...
              <form @submit.prevent="submit">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                  ...
                  <!-- Email -->
                  <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1.5">{{ t.form.email_label }}</label>
                    <input
                      v-model="form.email"
                      type="email"
                ...
                <div class="mb-6">
                  <label class="block text-sm font-medium text-gray-700 mb-1.5">
                    ...
                    <span class="text-gray-400 font-normal">{{ t.form.message_optional }}</span>
                  </label>
                  <textarea
                    v-model="form.message"
                    rows="3"
                    :placeholder="t.form.message_placeholder"
                    class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white text-sm font-semibold px-6 py-2.5 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
            ...
            <section class="bg-white rounded-lg shadow-xs overflow-hidden">
              <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                <h2 class="text-xl font-semibold text-gray-900">
                  {{ t.pending.title }}
                  <span class="ml-2 text-sm font-normal text-gray-400">({{ pendingInvitations.length }})</span>
                </h2>
              </div>

              <div v-if="pendingInvitations.length === 0" class="px-6 py-12 text-center text-sm text-gray-400">
                {{ t.pending.empty }}
              </div>
                ...
                <table class="w-full text-sm">
                  ...
                  <tbody class="divide-y divide-gray-100">
                    <tr v-for="inv in pendingInvitations" :key="inv.id" class="hover:bg-gray-50 transition-colors">
                      ...
                      <td class="px-6 py-4 text-gray-500">{{ inv.expires_at }}</td>
            ...
            <div class="bg-blue-50 rounded-lg p-6 border border-blue-200 sticky top-4">
              ...
              <div class="space-y-4 text-sm">
                ...
                <div class="border-t border-blue-200 pt-4">
                  <p class="font-medium text-gray-900 mb-2">{{ t.info_panel.process_heading }}</p>
