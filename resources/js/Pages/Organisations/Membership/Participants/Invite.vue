            ...
            <section class="bg-white rounded-lg shadow-xs p-6 mb-8">
              ...
              <form @submit.prevent="submit">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                  ...
                  <!-- Participant Type -->
                  <div>
                    <label class="block text-sm font-medium text-neutral-700 mb-1.5">{{ t.form.type_label }}</label>
                    <select
          ...
          <aside v-if="t.info_panel" class="lg:col-span-1" aria-label="Participant invitation information">
            <div class="bg-primary-50 rounded-lg p-6 border border-primary-200 sticky top-4">
              ...
              <div class="space-y-4 text-sm">
                ...
                <div>
                  <p class="font-medium text-neutral-900 mb-2">{{ t.info_panel.types_heading }}</p>
