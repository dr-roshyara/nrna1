      ...
      <div class="flex gap-1 mb-5 border-b border-gray-200">
        ...
        >
          ...
          <span
            ...
            :class="filterStatus === tab.value ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-500'"
      ...
      <div class="bg-white rounded-lg shadow overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ t.col_applicant }}</th>
              ...
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ t.col_submitted }}</th>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="app in filteredApplications" :key="app.id" class="hover:bg-gray-50 transition-colors">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm">
                <span :class="isExpiringSoon(app.expires_at) ? 'text-orange-600 font-medium' : 'text-gray-400'">
        ...
        <!-- Pagination -->
        <div v-if="applications.last_page > 1" class="px-6 py-4 border-t border-gray-100 flex items-center justify-between text-sm text-gray-600">
          ...
          <div class="flex gap-2">
            <a v-if="applications.prev_page_url" :href="applications.prev_page_url"
               class="px-3 py-1 rounded border border-gray-300 hover:bg-gray-50">{{ t.prev }}</a>
            <a v-if="applications.next_page_url" :href="applications.next_page_url"
               class="px-3 py-1 rounded border border-gray-300 hover:bg-gray-50">{{ t.next }}</a>
          </div>
        </div>
      </div>
