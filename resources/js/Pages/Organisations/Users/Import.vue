                  ...
                  <table class="w-full text-sm">
                    <thead class="sticky top-0 bg-gray-100 border-b border-gray-200">
                      <tr>
                        ...
                        <th class="px-3 py-2 text-left font-medium text-gray-700">{{ t.preview.table.name }}</th>
                        <th class="px-3 py-2 text-left font-medium text-gray-700">{{ t.preview.table.member }}</th>
                        <th class="px-3 py-2 text-left font-medium text-gray-700">{{ t.preview.table.voter }}</th>
                    ...
                    <tbody>
                      <tr v-for="row in previewData.preview" :key="row.row"
                        ...
                        <td class="px-3 py-2 text-center">
                          <span :class="row.is_member ? 'text-green-600' : 'text-gray-400'">
                            {{ row.is_member ? '✓' : '—' }}
                          </span>
                        </td>
                        <td class="px-3 py-2 text-center">
                          <span :class="row.is_voter ? 'text-blue-600' : 'text-gray-400'">
                            {{ row.is_voter ? '✓' : '—' }}
                          </span>
                        </td>
                        <td class="px-3 py-2">
