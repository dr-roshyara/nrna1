          ...
          <div class="lg:col-span-2">
            ...
            <section v-if="currentStep === 'upload'" class="bg-white rounded-lg shadow-xs p-6 mb-6">
              ...
              <div @drop="handleFileDrop" @dragover.prevent="isDragging = true" @dragleave="isDragging = false"
                ...
                <svg class="mx-auto h-12 w-12 text-neutral-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <table class="w-full text-sm">
                    <thead class="sticky top-0 bg-neutral-100 border-b border-neutral-200">
                      <tr>
                        ...
                        <th class="px-3 py-2 text-left font-medium text-neutral-700">{{ t.preview.table.name }}</th>
                        <th class="px-3 py-2 text-left font-medium text-neutral-700">{{ t.preview.table.member }}</th>
                        <th class="px-3 py-2 text-left font-medium text-neutral-700">{{ t.preview.table.voter }}</th>
                    ...
                    <tbody>
                      <tr v-for="row in previewData.preview" :key="row.row"
                        ...
                        <td class="px-3 py-2 text-neutral-700">{{ row.name }}</td>
                        <td class="px-3 py-2 text-center">
                          <span :class="row.is_member ? 'text-green-600' : 'text-neutral-400'">
                            {{ row.is_member ? '✓' : '—' }}
                          </span>
                        </td>
                        <td class="px-3 py-2 text-center">
                          <span :class="row.is_voter ? 'text-primary-600' : 'text-neutral-400'">
                            {{ row.is_voter ? '✓' : '—' }}
                          </span>
                        </td>
                        <td class="px-3 py-2">
          ...
          <aside class="lg:col-span-1" aria-label="File format information">
            <div class="bg-primary-50 rounded-lg p-6 border border-primary-200 sticky top-4">
              ...
              <div class="space-y-4 text-sm">
                ...
                <div class="border-t border-primary-200 pt-4">
                  <a :href="route('organisations.users.import.template', organisation.slug)"
...
import pageEn from '@/locales/pages/Organisations/Users/Import/en.json'
import pageDe from '@/locales/pages/Organisations/Users/Import/de.json'
import pageNp from '@/locales/pages/Organisations/Users/Import/np.json'
