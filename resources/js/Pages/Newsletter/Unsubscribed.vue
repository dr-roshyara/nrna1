<template>
    <div class="min-h-screen flex items-center justify-center bg-neutral-50">
        <div class="max-w-md w-full bg-white shadow rounded-lg p-8 text-center">
            ...
            <h1 class="text-2xl font-semibold text-neutral-900 mb-2">You have been unsubscribed</h1>
            <p class="text-neutral-500">You will no longer receive newsletter emails from this organisation.</p>
        </div>
    </div>
</template>
