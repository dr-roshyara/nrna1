    ...
    <nrna-layout>
        <div class="w-full bg-gradient-to-br from-gray-50 to-blue-50 py-6 md:py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <WorkflowStepIndicator v-if="showVotingMessage" :currentStep="5" />
            </div>
        </div>

        <div class="min-h-screen m-auto py-2">
            <div class="mt-10 mx-auto flex flex-col items-center justify-center">
                <!-- Dynamic message passed from controller -->
                <template v-if="message">
                    <p class="py-2 text-2xl font-bold text-primary-600">{{ message }}</p>
                    <p v-if="subMessage" class="text-lg text-slate-600 mt-2">{{ subMessage }}</p>
                    <div class="mt-6">
                        <a :href="previousRoute" class="inline-flex items-center px-6 py-3 bg-primary-600 text-white font-medium rounded-lg hover:bg-primary-700 transition-colors">
                            &larr; Go back
                        </a>
                    </div>
                </template>

                <!-- Default voting thank-you message (legacy) -->
                <template v-else>
                    <p class="py-2 text-2xl font-bold text-primary-600"> Thank you for the vote! मतदान गर्नु भएकोमा धन्यवाद ।</p>
                    <div class="text-left w-1/2">
                        आदरणिय मतदाता ज्यु,<br>
                        ...
                        आगामि दिनमा सवै जर्मनवासी नेपाली दिदी वहिनी तथा दाजुभाईहमा सदा झै सदभाव कायम रहि रहनेछ भन्ने विश्वास लिएका छौ । निर्वाचन सफल पार्न सहयोग गर्नु हुने यहाहरु सवैलाई विशेष धन्यवाद व्यक्त गर्न चाहन्छौ ।<br>
                        निर्वाचन आयोग<br>
                        गैर आवासिय नेपाली संघ जर्मनी
                    </div>
                </template>
            </div>
        </div>
