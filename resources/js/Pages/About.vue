<template>
  <div class="min-h-screen bg-neutral-50">
    ...
    <section class="py-16 sm:py-24">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
          <!-- Mission -->
          <div class="bg-white p-8 rounded-lg shadow-xs border border-neutral-200">
    ...
    <!-- Why Public Digit Section -->
    <section class="py-16 sm:py-24 bg-white border-t border-b border-neutral-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-bold text-neutral-900 text-center mb-12">
          {{ $t('about.why_public_digit_title') }}
        </h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div v-for="(feature, index) in whyPublicDigitFeatures" :key="index" class="bg-neutral-50 p-6 rounded-lg border border-neutral-200 hover:shadow-md transition">
            <h3 class="text-lg font-bold text-neutral-900 mb-3">{{ feature.title }}</h3>
    ...
    <section class="py-16 sm:py-24">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-primary-50 border-l-4 border-primary-500 p-8 rounded-sm">
    ...
    <section class="py-16 sm:py-24 bg-white border-t border-b border-neutral-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-bold text-neutral-900 mb-12">
    ...
    <section class="py-16 sm:py-24 bg-white border-t border-b border-neutral-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-neutral-50 p-8 rounded-lg border border-neutral-200">
          <p class="text-neutral-700 leading-relaxed text-lg">
            {{ $t('about.technology_text') }}
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="py-16 sm:py-24 bg-white border-t border-b border-neutral-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
          ...
          <a :href="`mailto:${supportEmail}`" class="inline-flex items-center px-6 py-3 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-700 transition">
            {{ supportEmail }}
          </a>
        </div>
      </div>
...
import aboutDe from '@/locales/pages/about/de.json'
import aboutEn from '@/locales/pages/about/en.json'
import aboutNp from '@/locales/pages/about/np.json'
...
export default {
  ...
  computed: {
    ...
    /**
     * Get about data for current locale
     * Falls back to English if locale not found
     */
    aboutContent() {
      return this.aboutData[this.currentLocale]?.about || this.aboutData.en?.about || {}
    },

    /**
     * Extract "Why Public Digit?" features array
     */
    whyPublicDigitFeatures() {
      return this.aboutContent.why_public_digit || []
    },

    /**
     * Extract security features array
     */
    securityFeaturesList() {
      return this.aboutContent.security_features || []
    },
