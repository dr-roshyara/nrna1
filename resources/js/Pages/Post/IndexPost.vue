        ...
        >
            <template #head>
                <tr>
                    ...
                    <th
                        class="border-r border-green-200"
                        v-show="showColumn('post_id')"
                        @click.prevent="sortBy('post_id')"
                    >
                        Post ID
                    </th>
                    <th
                    ...
                    <th
                        class="border-r border-green-200"
                        v-show="showColumn('required_number')"
                        @click.prevent="sortBy('required_number')"
                    >
                        Required Number
                    </th>
                    <th
                        class="border-r border-green-200"
                        v-show="showColumn('state_name')"
                        @click.prevent="sortBy('state_name')"
                    >
                        Scope
                    </th>
                </tr>
