        ...
        <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-8">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <header class="text-center mb-8">
                    ...
                    <p class="text-xl text-neutral-600 mb-4">Members Who Have Voted</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div class="bg-white rounded-xl shadow-lg p-6 border border-neutral-100">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-neutral-600">Total Voted</p>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 border border-neutral-100">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-neutral-600">Total Voters</p>
                                <p class="text-3xl font-bold text-primary-600">{{ stats.total_voters }}</p>
                            </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 border border-neutral-100">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-neutral-600">Participation</p>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-neutral-100 overflow-hidden">
                    ...
                    <div class="flex items-center justify-between px-6 py-4 border-b border-neutral-200 bg-neutral-50">
                        ...
                        <div class="text-sm text-neutral-600">
                            Showing <span class="font-semibold text-neutral-900">{{ votedUsers.from || 0 }}</span> to
                            <span class="font-semibold text-neutral-900">{{ votedUsers.to || 0 }}</span> of
                            <span class="font-semibold text-neutral-900">{{ votedUsers.total }}</span> results
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-neutral-100 border-b-2 border-neutral-200">
                                <tr>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="(code, index) in votedUsers.data" :key="code.id" class="hover:bg-neutral-50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-neutral-900">
                                        {{ votedUsers.from + index }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="shrink-0 h-10 w-10 bg-primary-100 rounded-full flex items-center justify-center">
                    ...
                    <div class="flex items-center justify-between px-6 py-4 border-t border-neutral-200 bg-neutral-50">
                        ...
                        <div class="text-sm text-neutral-600">
                            Page <span class="font-semibold text-neutral-900">{{ votedUsers.current_page }}</span> of
                            <span class="font-semibold text-neutral-900">{{ votedUsers.last_page }}</span>
                        </div>
