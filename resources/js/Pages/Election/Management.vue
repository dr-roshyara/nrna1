      ...
      <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6 relative z-10 overflow-x-hidden">
          ...
          <div class="w-full min-w-0 space-y-6">
            ...
            <div v-if="canCompleteAdministration || canOpenVoting || canCloseVoting" class="pt-4 border-t border-slate-200">
              ...
              <div class="flex flex-wrap gap-3">
                ...
                <transition name="fade-scale" mode="out-in">
                  <div v-if="canOpenVoting || !isNominationCompleted" key="open">
                    <div>
                      <ActionButton
                        variant="success"
                        size="md"
        ...
        <SectionCard padding="lg">
          ...
          <div class="flex flex-wrap gap-3">
            ...
            <ActionButton as="a" variant="outline" size="md" :href="voterNotifyUrl" class="w-full sm:w-auto" aria-label="Send an email notice to this election's voters">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
const voterNotifyUrl = computed(() =>
  route('organisations.membership.newsletters.create', props.organisation?.slug) + '?election_id=' + props.election.id
)
