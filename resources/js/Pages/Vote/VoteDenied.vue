        ...
        <div class="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 py-8 px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center mb-8">
                    ...
                    <h2 class="text-2xl font-semibold text-neutral-700 mb-6" v-if="title_nepali">
                        {{ title_nepali }}
                    </h2>
                    
                    <!-- User Info -->
                    <div class="inline-flex items-center px-4 py-2 bg-white rounded-full shadow-xs border">
                        <svg class="h-5 w-5 text-neutral-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                  d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                        <span class="text-neutral-600 font-medium">{{ user_name }}</span>
                        <span class="mx-2 text-neutral-300">•</span>
                        <span class="text-sm text-neutral-500">{{ getCurrentDateTime() }}</span>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-neutral-200 overflow-hidden">
                    ...
                    <!-- Denial Type Badge -->
                    <div class="px-6 py-4 bg-danger-600 text-white">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-danger-500 text-white">
                    ...
                    <div class="px-8 py-8">
                        ...
                        <!-- English Message -->
                        <div class="mb-6 p-6 bg-danger-50 rounded-lg border-l-4 border-danger-400">
                            <div class="flex items-start">
                                <svg class="h-6 w-6 text-danger-400 mt-1 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                          d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <div class="flex-1">
                                    <h3 class="text-lg font-semibold text-danger-800 mb-2">Error Details</h3>
                                    <p class="text-danger-700 leading-relaxed text-base">
                        ...
                        <div class="mb-6 p-6 bg-orange-50 rounded-lg border-l-4 border-orange-400" v-if="error_message_nepali">
                            <div class="flex items-start">
                                <svg class="h-6 w-6 text-orange-400 mt-1 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                        ...
                        <div class="mb-6" v-if="showTechnicalDetails">
                            <div class="bg-neutral-50 rounded-lg p-6">
                                <h3 class="text-lg font-semibold text-neutral-800 mb-4 flex items-center">
                                    <svg class="h-5 w-5 mr-2 text-neutral-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div v-if="votes_from_ip || max_votes_allowed">
                                        ...
                                        <div class="space-y-1">
                                            <div v-if="votes_from_ip" class="flex justify-between">
                                                <span class="text-neutral-600">Votes from IP:</span>
                                                <span class="font-semibold text-danger-600">{{ votes_from_ip }}</span>
                                            </div>
                                            <div v-if="max_votes_allowed" class="flex justify-between">
                                                <span class="text-neutral-600">Maximum allowed:</span>
                                    ...
                                    <div v-if="expired_minutes || time_limit">
                                        <h4 class="font-semibold text-neutral-700 mb-2">Time Information</h4>
                                        <div class="space-y-1">
                                            <div v-if="expired_minutes" class="flex justify-between">
                                                <span class="text-neutral-600">Minutes expired:</span>
                                                <span class="font-semibold text-danger-600">{{ expired_minutes }}</span>
                                            </div>
                                    ...
                                    <div v-if="voting_start || voting_end">
                                        <h4 class="font-semibold text-neutral-700 mb-2">Voting Hours</h4>
                                        <div class="space-y-1">
                                            <div class="flex justify-between">
                                                <span class="text-neutral-600">Allowed hours:</span>
                                                <span class="font-mono text-neutral-800">{{ voting_start }} - {{ voting_end }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mb-8">
                            ...
                            <!-- English Solution -->
                            <div class="mb-4 p-6 bg-primary-50 rounded-lg border-l-4 border-primary-400" v-if="solution_english">
                                <div class="flex items-start">
                                    <svg class="h-6 w-6 text-primary-400 mt-1 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                              d="M13 10V3L4 14h7v7l9-11h-7z" />
                                    </svg>
                                    <div class="flex-1">
                                        <h4 class="text-lg font-semibold text-primary-800 mb-2">Solution</h4>
                            ...
                            <div class="mb-4 p-6 bg-green-50 rounded-lg border-l-4 border-green-400" v-if="solution_nepali">
                                <div class="flex items-start">
                                    <svg class="h-6 w-6 text-green-400 mt-1 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                        ...
                        <!-- Contact Information -->
                        <div class="mb-8 bg-neutral-100 rounded-lg p-6">
                            <h3 class="text-lg font-semibold text-neutral-800 mb-4 flex items-center">
                                <svg class="h-5 w-5 mr-2 text-neutral-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                <div>
                                    <p class="text-neutral-600 mb-1">Email:</p>
                                    <a href="mailto:election@nrna.org" class="text-primary-600 hover:text-primary-800 font-medium">
                                        election@nrna.org
                                    </a>
                                </div>
                                <div>
                                    <p class="text-neutral-600 mb-1">Reference ID:</p>
                                    <span class="font-mono text-neutral-800 bg-white px-2 py-1 rounded-sm">
                                        {{ generateReferenceId() }}
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link :href="route('dashboard')" 
                                  class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200">
                            ...
                            <button @click="toggleTechnicalDetails" 
                                    class="inline-flex items-center justify-center px-6 py-3 border border-neutral-300 text-base font-medium rounded-lg text-neutral-700 bg-white hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition duration-200">
                                <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
