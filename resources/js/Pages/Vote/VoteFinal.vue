                ...
                <div class="mb-12 bg-gradient-to-r from-green-500 to-emerald-600 rounded-3xl shadow-2xl overflow-hidden">
                    <div class="relative px-8 py-16 md:py-20 text-center">
                        ...
                        <div class="relative z-10">
                            ...
                            <!-- Confirmation Number -->
                            <div class="bg-white/20 backdrop-blur-sm rounded-2xl px-8 py-4 inline-block">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div class="p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl border border-purple-200">
                                    <div class="flex items-start mb-3">
                                        <div class="w-8 h-8 bg-purple-600 text-white rounded-full flex items-center justify-center font-bold mr-3 flex-shrink-0">1</div>
                                ...
                                <div class="p-6 bg-gradient-to-br from-orange-50 to-red-50 rounded-xl border border-orange-200">
                                    <div class="flex items-start mb-3">
                                        <div class="w-8 h-8 bg-orange-600 text-white rounded-full flex items-center justify-center font-bold mr-3 flex-shrink-0">4</div>
