<template>
    <section
        ...
        :class="{
            'border-danger-400 bg-danger-50': hasError,
    ...
    >
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-5 text-white transition-all duration-300"
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex items-center gap-3 w-full">
                    ...
                    <div v-if="hasError" class="shrink-0">
                        <svg class="h-6 w-6 text-danger-200" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div v-if="hasError" class="bg-danger-50 border-l-4 border-danger-500 px-6 py-4 -mx-6 -mt-5 -mb-5 flex items-start gap-3 mt-4" role="alert" aria-live="polite" aria-atomic="true" :aria-labelledby="`post-error-${post.post_id}`">
                ...
                <div>
                    <h3 :id="`post-error-${post.post_id}`" class="text-sm font-medium text-danger-800">
