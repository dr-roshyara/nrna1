<template>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6 max-w-4xl mx-auto">
        ...
        <div class="mb-6 p-4 bg-primary-50 rounded-lg border-l-4 border-primary-500">
            <p class="text-neutral-800 leading-relaxed">
                We have sent you an email
                <span class="font-bold text-danger-600 bg-danger-100 px-2 py-1 rounded-sm">
        ...
        <div class="p-4 bg-green-50 rounded-lg border-l-4 border-green-500">
            ...
            <p class="mt-3 text-sm font-semibold text-danger-700 bg-danger-50 p-2 rounded-sm">
    ...
    <form @submit.prevent="submit" class="mx-auto mt-6 w-full text-center md:w-2/3">
        <div class="mx-2 bg-white rounded-lg shadow-lg border border-neutral-200 px-6 py-8">
            <!-- Code Input -->
            <div class="mb-6">
                <label for="voting_code" class="block mb-4">
                    <div class="flex items-center justify-center mb-2">
                        <span class="text-2xl mr-2">🔑</span>
                        <p class="text-xl font-bold text-neutral-900">First Voting Code</p>
                    </div>
                </label>
                <input
                    class="w-full md:w-2/3 mx-auto block rounded-lg border-2 border-primary-300 bg-neutral-50 p-4 text-xl font-bold text-neutral-900 text-center focus:border-primary-500 focus:bg-white transition-all"
                    id="voting_id"
            ...
            <div class="mb-4">
                <button
                    type="submit"
                    class="w-full md:w-2/3 bg-primary-600 hover:bg-primary-700 text-white font-bold py-4 px-6 rounded-lg transition-colors shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
                >
                    🗳️ PRESS HERE TO GET VOTING FORM
                </button>
                <p class="mt-2 text-sm text-neutral-600">भोटिङ फर्म प्राप्त गर्न यहाँ थिच्नुहोस्</p>
            </div>
