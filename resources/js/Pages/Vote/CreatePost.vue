     ...
     get_nepali_name(post_id){
       //president 
        ...
        if(post_id=="2021_13"){
         ...
         if(post_id=="2021_22"){
            return "क्षेत्रिय  महिला संयोजक एसिया प्यासिफिक" 
        }
          if(post_id=="2021_23"){
            return "क्षेत्रिय  महिला संयोजक मध्य एसिया" 
        }
          if(post_id=="2021_24"){
            return "क्षेत्रिय  महिला संयोजक अफ्रिका" 
        }
        //
        if(post_id=="2021_25"){
            return "क्षेत्रिय  युवा संयोजक युरोप" 
        }
          if(post_id=="2021_26"){
            return "क्षेत्रिय  युवा संयोजक अमेरिकाज" 
        }
         if(post_id=="2021_27"){
            return "क्षेत्रिय  युवा संयोजक ओसियाना" 
        }
         if(post_id=="2021_28"){
            return "क्षेत्रिय  युवा संयोजक एसिया प्यासिफिक" 
        }
          if(post_id=="2021_29"){
            return "क्षेत्रिय  युवा संयोजक मध्य एसिया" 
        }
          if(post_id=="2021_30"){
            return "क्षेत्रिय  युवा संयोजक अफ्रिका" 
        }
        //
         if(post_id=="2021_31"){
            return "क्षेत्रिय सह संयोजक युरोप" 
        }
          if(post_id=="2021_32"){
            return "क्षेत्रिय सह संयोजक अमेरिकाज" 
        }
         if(post_id=="2021_33"){
            return "क्षेत्रिय  सह संयोजक ओसियाना" 
        }
         if(post_id=="2021_34"){
            return "क्षेत्रिय सह संयोजक एसिया प्यासिफिक" 
        }
          if(post_id=="2021_35"){
            return "क्षेत्रिय  सह संयोजक मध्य एसिया" 
        }
          if(post_id=="2021_36"){
            return "क्षेत्रिय  सह संयोजक अफ्रिका" 
        }
        //
         //
         if(post_id=="2021_37"){
            return "क्षेत्रिय महिला सह संयोजक युरोप" 
        }
          if(post_id=="2021_38"){
            return "क्षेत्रिय  महिला सह संयोजक अमेरिकाज" 
        }
         if(post_id=="2021_39"){
            return "क्षेत्रिय  महिला सह संयोजक ओसियाना" 
        }
         if(post_id=="2021_40"){
            return "क्षेत्रिय  महिला सह संयोजक एसिया प्यासिफिक" 
        }
          if(post_id=="2021_41"){
            return "क्षेत्रिय  महिला सह संयोजक मध्य एसिया" 
        }
          if(post_id=="2021_42"){
            return "क्षेत्रिय  महिला सह संयोजक अफ्रिका" 
        }
         //
         if(post_id=="2021_43"){
            return "क्षेत्रिय युवा सह संयोजक युरोप" 
        }
          if(post_id=="2021_44"){
            return "क्षेत्रिय  युवा सह संयोजक अमेरिकाज" 
        }
         if(post_id=="2021_45"){
            return "क्षेत्रिय  युवा सह संयोजक ओसियाना" 
        }
         if(post_id=="2021_46"){
            return "क्षेत्रिय  युवा सह संयोजक एसिया प्यासिफिक" 
        }
          if(post_id=="2021_47"){
            return "क्षेत्रिय  युवा सह संयोजक मध्य एसिया" 
        }
          if(post_id=="2021_48"){
            return "क्षेत्रिय  युवा सह संयोजक अफ्रिका" 
        }
     },
        fillArray(value, len) {
        var arr = [];
