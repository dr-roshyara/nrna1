<template>
    <social-layout>
        ...
        <div class="flex w-full flex-col">
            ...
            <div class="flex flex-col justify-center bg-primary-50">
                <div class="m-auto">
                ...
                <form @submit.prevent="submit" class="mx-auto text-center">
                    <div class="m-2 flex flex-col justify-center px-2">
                        <div
                            class="m-auto mb-2 flex flex-col items-center justify-center space-x-4 p-4 font-bold text-neutral-900"
                        >
                            <label for="verified" class="mb-3 px-4 py-2">
                                <p class="tex-xl font-bold text-neutral-900">
