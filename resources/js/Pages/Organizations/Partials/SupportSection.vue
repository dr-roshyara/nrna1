<template>
  <section
    ...
    class="bg-linear-to-r from-blue-50 to-indigo-50 rounded-lg shadow-xs border-l-4 border-blue-500 overflow-hidden"
  >
    <div class="px-4 py-6 sm:px-6">
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-start gap-3 pt-2">
          <svg class="w-5 h-5 text-gray-400 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
      ...
      <div v-if="showAdditionalLinks" class="mt-6 pt-6 border-t border-blue-200">
        <div class="flex flex-col sm:flex-row gap-3">
          <a
            href="/handbook"
            class="inline-flex items-center justify-center px-4 py-2 border border-blue-300 text-sm font-medium rounded-md text-blue-600 hover:bg-blue-100 transition-colors"
          >
