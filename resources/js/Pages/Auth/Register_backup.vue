        ...
        <form @submit.prevent="submit">
         ...
         <!-- Add the other coulmns -->
            ...
            <div class="mt-4" v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature">
                <jet-label for="terms">
                    <div class="flex items-center">
                        ...
                        <div class="ml-2">
                            I agree to the <a target="_blank" :href="route('terms.show')" class="underline text-sm text-neutral-600 hover:text-neutral-900">Terms of Service</a> and <a target="_blank" :href="route('policy.show')" class="underline text-sm text-neutral-600 hover:text-neutral-900">Privacy Policy</a>
                        </div>
                    </div>
                </jet-label>
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                <inertia-link :href="route('login')" class="underline text-sm text-neutral-600 hover:text-neutral-900">
                    Already registered?
                </inertia-link>
