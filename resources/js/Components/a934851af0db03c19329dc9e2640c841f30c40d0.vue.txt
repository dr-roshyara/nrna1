 ...
 */
export const useOrganisationCreation = () => {
  ...
  const submitForm = () => {
    ...
    router.post(routeUrl, payload, {
      ...
      onSuccess: (page) => {
        ...
        // Track success
        trackOrganisationCreated(payload);
      ...
      onError: (errors) => {
        ...
        trackOrganisationCreationError(errors);
        isSubmitting.value = false;
      },
      onFinish: () => {
        isSubmitting.value = false;
   ...
   */
  const trackOrganisationCreationStarted = () => {
    if (window.gtag) {
  ...
  const trackOrganisationCreated = (data) => {
    if (window.gtag) {
  ...
  const trackOrganisationCreationError = (error) => {
    if (window.gtag) {
  ...
  return {
    ...
    submitForm,
    toggleSection,
    trackOrganisationCreationStarted,
    trackStepCompleted,
