    ...
    <div class="flex justify-center align-middle">
        <div class="mb-3 xl:w-96">
            ...
            >
                <input
                    type="search"
                    class="form-control relative m-0 block hidden w-full min-w-0 flex-auto rounded border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-1.5 text-base font-normal text-gray-700 transition ease-in-out focus:border-blue-600 focus:bg-white focus:text-gray-700 focus:outline-none"
                    placeholder="Search"
                    aria-label="Search"
