...
const organisationCreation = inject('organisationCreation');

// Use refs and values directly from the composable
const isModalOpen = organisationCreation.isModalOpen;
const currentStep = organisationCreation.currentStep;
const showEducation = organisationCreation.showEducation;
const formData = organisationCreation.formData;
const expandedSections = organisationCreation.expandedSections;
const validationErrors = organisationCreation.validationErrors;
const isSubmitting = organisationCreation.isSubmitting;
const submissionError = organisationCreation.submissionError;
const progressPercentage = organisationCreation.progressPercentage;
const canGoNext = organisationCreation.canGoNext;
const canGoPrevious = organisationCreation.canGoPrevious;

// Methods
const { closeModal, nextStep, previousStep, submitForm, toggleSection } = organisationCreation;
