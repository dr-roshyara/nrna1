 ...
 * These 14 actions are defined in ElectionConstitution and orchestrated by the capability resolver.
...
/**
 * All 14 action names in array form (for validation, iteration, etc.)
 */
