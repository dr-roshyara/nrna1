...
import publicSecurityDe from './locales/Pages/Public/Security/de.json';
import publicSecurityEn from './locales/Pages/Public/Security/en.json';
import publicSecurityNp from './locales/Pages/Public/Security/np.json';
