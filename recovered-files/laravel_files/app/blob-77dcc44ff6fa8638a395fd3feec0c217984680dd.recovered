...
export default {
  ...
  setup() {
    ...
    const organisationCreation = useOrganisationCreation();

    // Provide it to all child components (including modal)
    provide('organisationCreation', organisationCreation);
  ...
  methods: {
    createOrganization() {
      ...
      this.organisationCreation.openModal();
      this.organisationCreation.trackOrganizationCreationStarted();
    },
